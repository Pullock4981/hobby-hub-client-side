...
//             <li><NavLink to="/dashboard/MyGroup" className="font-bold">My Group</NavLink></li>
...
const NavBar = () => {
    ...
    const navLinks = (
        <ul className="flex md:flex-row flex-col px-2 gap-4">
            <li>
                <NavLink to="/" className={({ isActive }) => isActive ? "text-[white] bg-[#6C8EA7] font-bold" : "font-bold"}>
                    Home
                </NavLink>
            </li>
            <li>
                <NavLink to="/allGroup" className={({ isActive }) => isActive ? "text-[white] bg-[#6C8EA7] font-bold" : "font-bold"}>
                    All Group
                </NavLink>
            </li>
            <li>
                <NavLink to="/dashboard" className={({ isActive }) => isActive ? "text-[white] bg-[#6C8EA7] font-bold" : "font-bold"}>
                    Dashboard
                </NavLink>
            </li>
        </ul>
        ...
        <nav className="sticky top-0 z-50 shadow bg-base-100 text-base-content">
            <div className="navbar shadow-sm md:px-10 px-4">
                ...
                <div className="navbar-start">
                    ...
                    <div className="flex items-center gap-2">
                        <img src={logo} alt="HobbyHub Logo" className="h-10" />
                        <span className="font-bold text-xl hidden md:block">HobbyHub</span>
                    </div>
                </div>
