...
const UpdateDetails = () => {
    ...
    return (
        <div className='md:mx-16 mx-4'>
            <h1 className="text-2xl font-semibold mt-4">Update Group Details</h1>
            <form onSubmit={handleUpdateSubmit}>
                <div className='grid md:grid-cols-2 gap-4 mt-10 mb-4'>
                ...
                <fieldset className="fieldset bg-base-200 border p-4">
                    <label className="label">Description</label>
                    <textarea name='description' defaultValue={description} className="textarea w-full" placeholder="Group Description" />
                </fieldset>
                <div className="form-control my-6">
                    <input type="submit" className="btn bg-[#2A9261] text-white font-bold w-full" value="Update Group" />
                </div>
