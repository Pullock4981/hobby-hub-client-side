...
const UpdateDetails = () => {
    ...
    return (
        <div className='md:px-20 px-4 py-8 bg-base-100 text-base-content'>
            <h1 className="text-2xl font-semibold mb-6">Update Group Details</h1>

            <form onSubmit={handleUpdateSubmit}>
                <div className='grid md:grid-cols-3 gap-3'>
                    <div>
                        <label className="label">Group Name</label>
                        <input type="text" name='groupName' defaultValue={groupName} className="input input-bordered w-full" required />
                    </div>
                    <div>
                        <label className="label">Hobby Category</label>
                        <input type="text" name='hobbyCategory' defaultValue={hobbyCategory} className="input input-bordered w-full" required />
                    </div>
                    <div>
                        <label className="label">Meeting Location</label>
                    ...
                    <div>
                        <label className="label">Max Members</label>
                        <input type="number" name='maxMembers' defaultValue={maxMembers} className="input input-bordered w-full" required />
                    </div>
                    <div>
                        <label className="label">Start Date</label>
                    ...
                    <div>
                        <label className="label">Photo URL</label>
                        <input type="text" name='image' defaultValue={photo} className="input input-bordered w-full" required />
                    </div>
                    <div>
                        <label className="label">User Name</label>
                    ...
                    <div>
                        <label className="label">User Email</label>
                        <input type="email" name='userEmail' defaultValue={userEmail} readOnly className="input input-bordered w-full" />
                    </div>
                </div>
                ...
                <div className="form-control py-6">
                    <input type="submit" className="btn bg-[#6C8EA7] text-white font-bold w-full" value="Update Group" />
                </div>
            </form>
        </div>
    );
